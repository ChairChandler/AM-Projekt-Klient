...
data class Place(var position: Location, var title: String);
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // this.localisations = TODO(TUTAJ UZYSKUJEMY POZYCJE SZPITALI WRAZ Z NAZWA)
    }
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        for (pos in this.hospitalsLocalisation) {
            ...
            mMap.addMarker(MarkerOptions().position(place).title(pos.title))
        }
        val user = LatLng(this.userLocalisation.latitude, this.userLocalisation.longitude)
